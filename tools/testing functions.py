...
# Server
# client_connection, line 24 ({keys} .send)
# client_connection, line 27 (Server_Recv = .recv)
# login_attempt, line 46 ('login_attempt;False'.send)
# key_request, line 54 (keys.send)
# key_request, line 57 ('key_request;False'.send)
# create_acc, line 64 ('create_acc;False')
# create_acc, line 70 ('create_acc;True)
